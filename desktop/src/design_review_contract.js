...
export const DESIGN_REVIEW_REQUEST_SCHEMA = "cue.design_review_request.v1";
export const DESIGN_REVIEW_PROPOSAL_SCHEMA = "cue.design_review_proposal.v1";
export const DESIGN_REVIEW_APPLY_REQUEST_SCHEMA = "cue.design_review_apply_request.v1";
export const DESIGN_REVIEW_ACCOUNT_MEMORY_SCHEMA = "cue.design_review_account_memory.v1";
export const DESIGN_REVIEW_UPLOAD_ANALYSIS_SCHEMA = "cue.design_review_upload_analysis.v1";
export const DESIGN_REVIEW_PLANNER_TRACE_SCHEMA = "cue.design_review_planner_trace.v1";
export const DESIGN_REVIEW_PLANNER_TRACE_KIND = "design_review_planner_trace";
...
export const DESIGN_REVIEW_PROVIDER_COMMAND = "run_design_review_provider_request";
