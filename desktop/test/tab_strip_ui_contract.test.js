...
test("Session tab strip CSS keeps the strip compact, scrollable, and stateful", () => {
  ...
  assert.match(css, /body\.juggernaut-shell \.brand-strip \.session-tab-strip-action\.has-action-provenance,\s*body\.juggernaut-shell \.brand-strip \.session-tab-runtime-action\.has-action-provenance\s*\{[\s\S]*background:\s*rgba\(204,\s*185,\s*180,\s*0\.98\);[\s\S]*box-shadow:\s*none;/);
  assert.match(css, /body\.juggernaut-shell \.brand-strip \.session-tab-strip-action\.has-action-provenance:hover,\s*body\.juggernaut-shell \.brand-strip \.session-tab-strip-action\.has-action-provenance:focus-visible,\s*body\.juggernaut-shell \.brand-strip \.session-tab-runtime-action\.has-action-provenance:hover,\s*body\.juggernaut-shell \.brand-strip \.session-tab-runtime-action\.has-action-provenance:focus-visible\s*\{[\s\S]*background:\s*rgba\(204,\s*185,\s*180,\s*0\.98\);[\s\S]*box-shadow:\s*none;/);
  assert.match(css, /body\.juggernaut-shell \.brand-strip \.session-tab-strip-action\.has-action-provenance span,\s*body\.juggernaut-shell \.brand-strip \.session-tab-strip-action\.has-action-provenance \.session-tab-action-icon \.tool-icon,\s*body\.juggernaut-shell \.brand-strip \.session-tab-runtime-action\.has-action-provenance span,\s*body\.juggernaut-shell \.brand-strip \.session-tab-runtime-action\.has-action-provenance \.session-tab-action-icon \.tool-icon\s*\{[\s\S]*color:\s*rgba\(0,\s*0,\s*0,\s*0\.92\);/);
