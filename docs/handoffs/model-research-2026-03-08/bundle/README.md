...
`PROMPT.md` lives in this directory. This portable bundle, and `juggernaut-model-research-handoff-2026-03-08.tar.gz` when extracted into `juggernaut-model-research-handoff-2026-03-08/`, contain:
