...
Use this when running Codex agents in Warp with multiple tabs and separate git worktrees.
...
- Use 5 tabs first:
  ...
  - edit
  - export
- Only add the iconography tab if the shell branch is already stable and you still have bandwidth before the 5:30 PM target.
...
- For today’s 5:30 PM sprint, prefer the tailored prompts in [`TODAY_LAUNCH_TASKS.md`](/Users/mainframe/Desktop/projects/Juggernaut/docs/runbooks/TODAY_LAUNCH_TASKS.md).
