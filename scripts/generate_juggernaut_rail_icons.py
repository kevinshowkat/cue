#!/usr/bin/env python3
"""Generate provider-backed Cue rail icon packs via Oscillo Gemini."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate Cue rail icon packs with Oscillo Gemini.")
